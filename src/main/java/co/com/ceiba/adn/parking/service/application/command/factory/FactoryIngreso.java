...
public class FactoryIngreso {
	...
	public Ingreso create(CommandIngreso commandIngreso) {
		return new Ingreso(commandIngreso.getId(), 
				commandIngreso.getPlaca(), 
				commandIngreso.getTipoVehiculo(), 
				commandIngreso.getCilindraje(), 
				commandIngreso.getRegistroEntrada());
	}
}
